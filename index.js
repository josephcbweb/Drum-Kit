...
for (var i = 0; i < numberOfDrums; i++) {
  document.querySelectorAll(".drum")[i].addEventListener("click", function () {
    ...
    soundKey(buttonLetter);
    buttonAnimation(buttonLetter);
  });
  //this is called an anonymous function and instead a seperate function can be called without the () if it is added then the function get called during loading);
}
